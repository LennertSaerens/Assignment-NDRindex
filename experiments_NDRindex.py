...
def generate_data(n_samples=1_000, n_features=2, n_clusters=1, cluster_std=5, center_box=(-10.0, 10.0)):
...
def run_experiment():
    ...
    best_methods, best_score = ndr.evaluate_data_quality(data, 100)
