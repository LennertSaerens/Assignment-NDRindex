...
def generate_data(n_samples=1000, n_features=2, n_clusters=3, cluster_std=0.5, center_box=(-10.0, 10.0)):
...
def run_experiment():
    ...
    best_methods, best_score = ndr.evaluate_data_quality(normalized_data, 100)
